...
const CareerPage = () => {
  return (
    <div className="flex flex-col items-center gap-36">
      ...
      <div className="px-14 w-full flex flex-col gap-18">
        {/* heading */}
        <div className="flex items-center justify-between gap-10">
          <h3 className="text-[#CC4237] text-[34px] font-bold font-montserrat w-[30%]">
            Meet the Team Work Behind Our Success
          </h3>
          <p className="text-xl w-[55%]">
        ...
        <img
          src="/c1.jpg"
          alt="c1"
          className="h-[70vh] w-full object-cover rounded-[50px]"
        />
      </div>

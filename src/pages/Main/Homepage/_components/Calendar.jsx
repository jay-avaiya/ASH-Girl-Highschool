  ...
  return (
    <div>
      <div className="w-full xl:px-16 md:px-10 px-5">
        <p className="font-bold md:text-[34px] text-[28px] text-[#CC4237] text-center font-montserrat">
          Academic Calendar
        </p>
        <p className="xl:w-[70%] w-[95%] mx-auto font-normal  md:text-[24px] text-[20px] text-[#213455] text-center mt-5">
          Learning at Ash Girls High School goes beyond classrooms. Our students
          actively participate in cultural, academic, and sports events
          throughout the year.
        </p>
                        ...
                        >
                          <span
                            className={[
                              ...
                              isSelected
                                ? "bg-[#CC4237] text-white"
                                : isToday
                                ? " bg-[#005478] text-white"
                                : isEventDay
                                ? "bg-[#CC4237]/20 text-[#2A4767] font-medium"
                                : "",
                            ].join(" ")}
                          >
                            {cell.date.getDate()}
          ...
          <div className="events lg:w-[50%] w-full h-full flex flex-col gap-y-7">
            {events.map((e, idx) => (
              <button
                ...
                className="text-left w-full relative flex gap-x-5 rounded-[10px] md:h-[130px] h-fit bg-white border-[3.5px] border-[#CC4237] p-2 hover:shadow-md transition"
              >
                ...
                {/* left tab notch */}
                <div className="w-[35px] h-[35px] absolute top-11 -left-4.5 rounded-full bg-white border-[1.2px] border-[#CC4237] flex justify-center items-center">
                  <ChevronLeft color="#CC4237" />
                </div>
              </button>
            ))}
          </div>

      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        <div className="flex flex-col items-center md:flex-row md:justify-between">
          ...
          <div className="space-y-3 md:space-y-5">
            ...
            <label
              htmlFor="studentPic"
              className="w-[160px] h-[160px] lg:w-[220px] lg:h-[220px] xl:w-[280px] xl:h-[280px] bg-white rounded-[30px] border border-[#CC4237] border-dashed cursor-pointer flex items-center justify-center overflow-hidden relative"
            >
              {preview ? (
                <img
                  src={preview}
                ...
                <div className="flex flex-col items-center gap-4">
                  <ImageIcon className="w-7 h-7 xl:w-[83px] xl:h-[83px] text-[#CC4237]" />
          ...
          <div className="w-[270px] md:w-[360px] lg:w-[520px] xl:w-[750px] mt-4 md:mt-0 space-y-2">
            ...
            <button
              ...
              className={`flex items-center gap-3.5 lg:gap-5 py-2 w-full rounded-full justify-center border cursor-pointer 
                ${
                  isSubmitting

...
//         {/* title */}
//         <h3 className="text-purple-600 md:text-amber-400 lg:text-teal-400 xl:text-[#CC4237] font-bold font-montserrat text-3xl lg:text-[34px]">
//           Get in Touch
//         </h3>
...
//         {/* outermost */}
//         <div
//           className="bg-[#FFEDEA] p-2 md:p-6 rounded-[48px] h-fit
...
//               {/* innermost */}
//               <div className="border-2 border-[#CC4237] rounded-[50px] bg-white min-h-[850px] md:min-h-[850px] w-full max-w-[900px] px-6 md:px-10 flex flex-col py-10 space-y-10 items-center">
//                 {/* title */}
